...
app.post('/decompose-image', upload.single('image'), async (req, res) => {
    ...
    const prompt = "Give me summarized instructions to recycle or reuse this? (Give ans that are applicable on an individual scale. Also Don't give instruction's on living things or potentialy dangeours or illegal objects.npm )";
